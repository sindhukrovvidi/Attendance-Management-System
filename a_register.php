...
<div class="w3-top">
  <div class="w3-bar w3-white w3-card" id="myNavbar">
    ...
    <div class="w3-right w3-hide-small">
      <a href="a_register.php" class="w3-bar-item w3-button"><h5>SIGN UP</h5></a>
      <a href="a_index.php" class="w3-bar-item w3-button"><h5>SIGN IN</h5></a>
...
<nav class="w3-sidebar w3-bar-block w3-black w3-card w3-animate-left w3-hide-medium w3-hide-large" style="display:none" id="mySidebar">
  ...
  <a href="a_register.php" onclick="w3_close()" class="w3-bar-item w3-button">SIGN UP</a>
