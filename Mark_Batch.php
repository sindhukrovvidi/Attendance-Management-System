...
if(isset($_POST['batch']))
{
  ...
  $selected1 = $_POST['batch'];
  $_SESSION['batch1']=$selected1;
  //$course = $_SESSION['course1'];
...
else if($selected1 != $_SESSION['sem1']){
...
//echo "Fail";
  	header("Location: /Attendance_Management/Mark_Attendance/Mark_Section.php");
